module DoubleDouble
  describe Transaction do
    ...
    it "should create a transaction" do
      -> {
        transaction = FactoryGirl.build(:transaction_with_credit_and_debit_amounts)
        transaction.save!
    ...
    it "should not be valid with an invalid credit amount" do
      transaction = FactoryGirl.build(:transaction)
      expect{FactoryGirl.build(:credit_amount, :transaction => transaction, :amount => nil)}.to raise_error(ArgumentError)
    end
    ...
    it "should not be valid with an invalid debit amount" do
      transaction = FactoryGirl.build(:transaction)
      expect{FactoryGirl.build(:debit_amount, :transaction => transaction, :amount => nil)}.to raise_error(ArgumentError)
    end

    it "should not be valid without a description" do
      transaction = FactoryGirl.build(:transaction_with_credit_and_debit_amounts, :description => nil)
      transaction.should_not be_valid
    ...
    it "should have a polymorphic commercial document associations" do
      ...
      transaction = FactoryGirl.build(:transaction_with_credit_and_debit_amounts, :commercial_document => mock_document)
      transaction.save
